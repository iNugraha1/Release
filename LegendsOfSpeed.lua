...
local w = library:AddWindow("Legends Of Speed", {
...
main:AddSwitch("Auto Farm / Enabled", function(bool)
	autofarm = bool 
end)

main:AddSwitch("Red Orb", function(bool)
	red = bool 
end)

main:AddSwitch("Yellow Orb", function(bool)
	yellow = bool 
end)

main:AddSwitch("Blue Orb", function(bool)
	blue = bool 
end)

main:AddSwitch("Orange Orb", function(bool)
	orange = bool 
end)

main:AddSwitch("Gem", function(bool)
	gem = bool 
end)

main:AddSwitch("Auto Rebirth", function(bool)
	rebirth = bool
end)

main:AddSwitch("Auto Hoops", function(bool)
	hoops = bool 
end)
